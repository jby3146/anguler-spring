...
public class BoardService {
    ...
    public Board findBoard(String boardName) {
        return Optional.ofNullable(boardJpaRepo.findByName(boardName)).orElse(null);
    }
    // 게시판 이름으로 게시물 리스트 조회.
    ...
    public Post writePost(String uid, String boardName, ParamsPost paramsPost) {
        ...
        Post post = new Post(userJpaRepo.findById(Long.parseLong(uid)).orElse(null), board, paramsPost.getAuthor(), paramsPost.getTitle(), paramsPost.getContent());
